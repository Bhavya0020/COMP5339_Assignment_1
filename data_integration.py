...
#View column names
print("\nColumn names:")
print(fuelcheck_raw_data.columns.tolist())
...
#     fuelcheck_raw_data['Price'] = pd.to_numeric(fuelcheck_raw_data['Price'], errors='coerce')
...
fuelcheck_raw_data.to_csv('CleanedData.csv')